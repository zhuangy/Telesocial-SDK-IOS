...
/**
 ...
 - if a network ID has been registered and is associated with a particular application in the Telesocial system.
 ...
 If NO, only checks if the network ID is registered with the Telesocial system.
